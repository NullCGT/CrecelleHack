 ...
 */
    ...
    MON(NAM("gelatinous cube"), S_BLOB,
        ...
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_OMNIVORE
            | M1_ACID,
        M2_WANDER | M2_HOSTILE | M2_NEUTER, 0, BST_RAND1,
    ...
    MON(NAM("Blob"), S_BLOB,
        ...
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
        M2_WANDER | M2_HOSTILE | M2_NEUTER, 0, BST_RAND1 | BST_RAND2,
    ...
    MON(NAM("gremlin"), S_GREMLIN,
        ...
        M3_INFRAVISIBLE | M3_TRAITOR | M3_TRIPPER, BST_RAND1,
        8, CLR_GREEN, GREMLIN),
    ...
    MON(NAM("blue jelly"), S_JELLY,
        ...
        A(ATTK(AT_TUCH, AD_COLD, 6, 6), ATTK(AT_NONE, AD_COLD, 0, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("spotted jelly"), S_JELLY,
        ...
        A(ATTK(AT_TUCH, AD_ACID, 6, 6), ATTK(AT_NONE, AD_ACID, 0, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("energy vortex"), S_VORTEX,
        ...
        M2_HOSTILE | M2_NEUTER, 0, BST_RAND1, 
    ...
    MON(NAM("shrieker"), S_FUNGUS,
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, BST_FUNGI | BST_BLOOD, 
    ...
    MON(NAM("violet fungus"), S_FUNGUS,
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, BST_FUNGI | BST_ROCK, 
    ...
    MON(NAM("quantum mechanic"), S_QUANTMECH,
        ...
        M3_INFRAVISIBLE | M3_AMBUSHER, BST_RAND1,
    ...
    MON(NAM("disenchanter"), S_RUSTMONST,
        ...
        M2_HOSTILE, M3_INFRAVISIBLE | M3_TRAITOR, BST_RAND1,
    ...
    MON(NAM("Dudley"), S_HUMAN,
        ...
        M3_INFRAVISIBLE, BST_RAND1, 12, HI_DOMESTIC, DUDLEY),
    ...
    MON(NAM("doppelganger"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_HOSTILE | M2_STRONG | M2_COLLECT
            | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE | M3_AMBUSHER | M3_TRIPPER, BST_RAND1,
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAM("chameleon"), S_LIZARD,
        ...
        BST_RAND1, 7, CLR_BROWN, CHAMELEON),
    ...
    MON(NAMS("Lord Carnarvon", "Lady Carnavon", "Lord Carnavon"), S_HUMAN,
        ...
        BST_RAND1 | BST_GRASS, 24, HI_LORD, LORD_CARNARVON),
    MON(NAM("Pelias"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE,
        BST_RAND1 | BST_GRASS, 24, HI_LORD, PELIAS),
    MON(NAM("Shaman Karnov"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE,
        BST_RAND1 | BST_GRASS, 24, HI_LORD, SHAMAN_KARNOV),
    ...
    MON(NAM("Earendil"), S_HUMAN,
        ...
        BST_RAND1 | BST_GRASS, 22, HI_LORD, EARENDIL),
    ...
    MON(NAM("Hippocrates"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE,
        BST_RAND1 | BST_GRASS, 26, HI_LORD, HIPPOCRATES),
    MON(NAMS("King Arthur", "Queen Arthur", "Arthur"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC, M3_CLOSE | M3_INFRAVISIBLE,
        BST_RAND1 | BST_GRASS, 24, HI_LORD, KING_ARTHUR),
    MON(NAMS("Grand Master", "Grand Mistress", "Grand Master"), S_HUMAN,
        ...
        BST_RAND1 | BST_GRASS, 30, CLR_BLACK, GRAND_MASTER),
    MON(NAMS("Arch Priest", "Arch Priestess", "Arch Cleric"), S_HUMAN,
        ...
        BST_RAND1 | BST_GRASS, 30, CLR_WHITE, ARCH_PRIEST),
    MON(NAM("Orion"), S_HUMAN, LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISION | M3_INFRAVISIBLE, BST_RAND1 | BST_GRASS,
        24, HI_LORD, ORION),
