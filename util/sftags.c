...
const struct already_in_sfbase already[] = {
    ...
    { NHTYPE_COMPLEX, "Sfi_permonst", "Sfi_x_permonst" },
    ...
    { NHTYPE_COMPLEX, "Sfo_permonst", "Sfo_x_permonst" },
...
struct nh_classification nhdatatypes[] = {
    ...
    { 0, NHTYPE_COMPLEX, "sfi_permonst", "sfi_permonst" },
    ...
    { 0, NHTYPE_COMPLEX, "sfo_permonst", "sfo_permonst" },
