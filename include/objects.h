...
#define XTRA_HELM_APPEARANCE(text, col, fire, cold, sleep, disint, shock, pois, hn) \
       HELM(NoDes, text, 0, 0, 0, 0, 0, 50, 50, 9, 0, IRON, col, fire, cold, sleep, disint, shock, pois, hn)
XTRA_HELM_APPEARANCE("frog-mouthed helm", CLR_GREEN, 10, -10, 10, 10, 10, 20,    HN01),
XTRA_HELM_APPEARANCE("close helmet",      HI_METAL,  10, 20, -10, 10, 10, 10,    HN02),
XTRA_HELM_APPEARANCE("full helm",         HI_METAL, -10, 10, 10, 10, 10, 10,     HN03),
XTRA_HELM_APPEARANCE("horned helmet",     CLR_YELLOW, 10, 10, 10, 20, -10, 10,   HN04),
...
CLOAK("cloak of protection", "tattered cape",
      ...
      5, 5, 5, 5, 5, 5,  
                                                        CLOAK_OF_PROTECTION),
#define XTRA_CLOAK_APPEARANCE(name, col, fire, cold, sleep, disint, shock, pois, cn) \
       CLOAK(NoDes, name, 0, 1, 0, 0, 0, 10, 0, 0, 0, CLOTH, col, fire, cold, sleep, disint, shock, pois, cn)
XTRA_CLOAK_APPEARANCE("diaphanous veil",         CLR_GRAY,  5, -15, 5, 5, 5, 15,     CN01),
XTRA_CLOAK_APPEARANCE("heavy mantle",            CLR_RED,   15, 5, -15, 5, 5, 5,     CN02),
XTRA_CLOAK_APPEARANCE("voluminous shroud",       CLR_BLACK, 5, 15, 5, -15, 5, 5,    CN03),
